...
/**
* \fn void ML_InitPad(void)
* \brief This function inits pads (Wii and GC).
*/
extern void ML_InitPad(void);
extern void ML_InitPadWii(void);
extern void ML_InitPadGC(void);
...
/**
* \fn void ML_GetPads(void)
* \brief This function receives the pads (Wii and GC) status.
*/
extern void ML_GetPads(void);
extern void ML_GetPadsWii(void);
extern void ML_GetNunchuk(void);
extern void ML_GetCPad(void);
extern void ML_GetGuitar(void);
extern void ML_GetPadsGC(void);
