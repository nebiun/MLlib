...
/**
* \fn u16 ML_DrawTextW(ML_Font *font, int x, int y, wchar_t *wText)
* \brief This function draws some wide text.
* @param font Font structure
* @param x X position
* @param y Y position
* @param wText Text
...
*/
extern u16 ML_DrawTextW(ML_Font *font, int x, int y, const wchar_t *wText);
...
* @return Number of characters printed
*/
extern u16 ML_DrawText(ML_Font *font, int x, int y, const char *text, ...);
...
*/
extern ML_TextInfo ML_GetTextInfo(ML_Font* font, const char* text, ...);

extern bool _loadFont(ML_Font *font, const char *filename, const uint8_t* buffer, FT_Long bufferSize, FT_UInt pointSize, bool fat);
