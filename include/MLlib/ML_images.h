...
extern void _initImage(ML_Image *image);
...
* \brief This function sets the color value of a pixel on a sprite. You need to call ML_FlushImage(void) after doing your modifications ! ;)
* @param image Image
...
* \brief This function inverts the image colors. You need to call ML_FlushImage(void) after doing your modifications ! ;)
* @param image Image
* @see ML_FlushImage
*/
...
* \brief This function applies grayscale onto the image. You need to call ML_FlushImage(void) after doing your modifications ! ;)
* @param image Image
* @see ML_FlushImage
*/
