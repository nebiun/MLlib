...
/**
* \fn extern void ML_InitMP3(void)
* \brief This function inits the MP3 player.
*/
extern void ML_InitMP3(void);

/**
* \fn extern void ML_StopMP3(void)
* \brief This function stops MP3s.
*/
extern void ML_StopMP3(void);

/**
* \fn bool ML_IsPlayingMP3(void)
* \brief This function detects if any MP3 is playing.
* @return Return a bool. (TRUE if playing)
*/
extern bool ML_IsPlayingMP3(void);
