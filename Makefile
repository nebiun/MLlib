...
#---------------------------------------------------------------------------------
#LIBS	:=	`freetype-config --libs` -logc -lwiiuse -lbte -lm -lasnd
...
install:
	...
	@cp lib/libml.a $(PORTLIBS_PATH)/wii/lib/libml.a
	@echo Installing include files...
	@[ -d $(PORTLIBS_PATH)/wii/include ] || mkdir -p $(PORTLIBS_PATH)/wii/include
	@cp -r include/MLlib $(PORTLIBS_PATH)/wii/include/.
	@cp include/MLlib.h $(PORTLIBS_PATH)/wii/include/.
	@echo Done

#---------------------------------------------------------------------------------
uninstall:
	@echo Removing library...
	@rm -f $(PORTLIBS_PATH)/wii/lib/libml.a
